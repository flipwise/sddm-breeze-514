...
Item {
    ...
    property real faceSize: config.AvatarPixelSize ? config.AvatarPixelSize : Math.min(width, height - usernameDelegate.height - units.largeSpacing)
    ...
    ShaderEffect {
        ...
        property var colorBorder: config.AvatarOutlineColor || PlasmaCore.ColorScope.textColor
